...
<?php 
    ...
    //// handle pagination
    $accessory = 37;
    $count = "SELECT COUNT(id) FROM product WHERE deleted = 0 AND category_id = $accessory";
    ...
    $sql = "SELECT * FROM product WHERE deleted = 0 AND category_id = $accessory LIMIT $index, $limit";
    ...
    <body>
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseFour" class="collapse show" data-parent="#accordionExample">
                                                <div class="card-body">
                                                    <ul>
                                                        <li class="box-shadow"><a href="accessory.php">Trang chủ</a></li>
                                                        <?php 
        ...
        <div class="instagram">
            <div class="container-fluid">
                <div class="row">
                    <?php 
                        $sql = "SELECT * FROM product WHERE deleted = 0 AND category_id = $accessory ORDER BY created_at DESC LIMIT 6";
                        $data = executeResult2($sql);
                        foreach ($data as $row) {
                            echo '
