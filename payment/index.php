...
<body>
	<!-- 9704366816072352011 -->
	<!-- 06-19 -->
	<!-- http://localhost/learnphp/learn_php/php_1/pay/checkout31/data.php?error_code=00&token=56637683-3806fa7d31176e773241891d6480e523&order_code=macode_1637039739&order_id=56637683 -->
	...
	<form name="NLpayBank" action="" method="post">
		<table >
			<tr>
				<td colspan="2">
					<p><span style="color:#ff5a00;font-weight:bold;text-decoration:underline;">Lưu ý</span> Bạn nhập đầy đủ thông tin sau
				</td>
			</tr>
			<tr>
		...
		<ul class="list-content">
			<li>
				<label><input type="radio" value="ATM_ONLINE" name="option_payment">
