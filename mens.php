...
<?php 
    ...
    //// handle pagination
    $men = 30;
    $count = "SELECT COUNT(id) FROM product WHERE deleted = 0 AND category_id = $men";
    ...
    $sql = "SELECT * FROM product WHERE deleted = 0 AND category_id = $men LIMIT $index, $limit";
    ...
    <body>
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseTwo" class="collapse show" data-parent="#accordionExample">
                                                <div class="card-body">
                                                    <ul>
                                                        <li class="box-shadow"><a href="mens.php">Trang chủ</a></li>
                                                        <?php 
                                                            $mens = $men;
                                        ...
                                        <div class="card">
                                            <div class="card-heading">
                                                <a data-toggle="collapse" data-target="#collapseThree">Shop trẻ nhỏ</a>
                                            </div>
                                            <div id="collapseThree" class="collapse" data-parent="#accordionExample">
                                                <div class="card-body">
                                                    <ul>
                                                        <li><a href="kids.php">Trang chủ</a></li>
                                                        <?php 
                                                            $kids = 35;
        ...
        <div class="instagram">
            <div class="container-fluid">
                <div class="row">
                    <?php 
                        $sql = "SELECT * FROM product WHERE deleted = 0 AND category_id = $men ORDER BY created_at DESC LIMIT 6";
                        $data = executeResult2($sql);
                        foreach ($data as $row) {
                            echo '
